 ...
 * <a href="https://gist.github.com/nathan-fiscaletti/9dc252d30b51df7d710a">source</a>
 */
public class AnsiStringBuilder {
    ...
    public <T> AnsiStringBuilder appendLine(T value) {
        this.append(value);
        this.append(System.lineSeparator());
        return this;
    }

    public <T> AnsiStringBuilder error(T value) {
        return this
                .color(ForegroundColor.RED)
                .append(value);
    }

    public <T> AnsiStringBuilder line() {
        this.append(System.lineSeparator());
        return this;
    }
